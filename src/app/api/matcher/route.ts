...
export async function POST(req: Request) {
  ...
  - For topCompanies, suggest 3 companies that are actively hiring for the suggested career path and their benefits must be UK based such as 28 days of annual leave, professional development opportunities and pension schemes.
